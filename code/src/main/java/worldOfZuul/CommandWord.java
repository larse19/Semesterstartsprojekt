...
public enum CommandWord
{
    ...
    GO("go"), QUIT("quit"), HELP("help"), UNKNOWN("?"), SOW("sow"), HARVEST("harvest"), WATER("water"), COLLECT("collect"), FEED("feed"), GRIND("grind"), GIVE("give"), CUSTOMER("customer"), SCORE("score"), COOK("cook"), INVENTORY("inventory"), RECIPE("recipe"), BALANCE("balance");
