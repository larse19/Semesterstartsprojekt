...
public class Game {
    ...
    private void printWelcome() {
        ...
        System.out.println("You start with 10.000 dollars, and each step you take, costs money. Once you run out, the game is over. Try to reach the highest score, before this happens.");
    ...
    private void printHelp() {
        ...
        System.out.println("Go: travel between rooms, second word specifies which direktion.");
        System.out.println("Collect: used to collect produce from animals, second word 'eggs' for eggs and 'milk' for milk.");
        System.out.println("Give: Give a food item to a customer. Second word specifies what food item");
        System.out.println();
        System.out.println("To increase your score, you have to feed customers. When a customer reaches 10 hp, they become fully fed, and a new customer will arrive.");
        System.out.println("Your score only increases, when a customer is fully fed.");
        System.out.println();
        System.out.println("The game runs on 'ticks'. Each valid command you write, increases the games ticks by 1.");
        System.out.println("Every 10 ticks, the customer loses 1 hp, and it takes 2 ticks, for a crop to grow, after it has been watered");
        System.out.println();
        ...
        System.out.println("Hint: Don't run out of corn");
